    ...
    service: {
        ...
        getInitialParam: (arr: CovidDataType[]): void => {
            ...
            CovidStore.store.setState({
                ...
                filterParam: {
                    ...
                    startDate: dateToSting(new Date(Math.min(Number(...dates)))),
                    endDate: dateToSting(new Date(Math.max(Number(...dates)))),
                },
            ...
            try {
                ...
                if (response) {
                    await CovidStore.store.setState({
                        ...
                        country: response.data.records.reduce((acc: { value: string; label: string }[], curr: CovidDataType) => {
        ...
        searchCountry: (country: string) => {
            ...
            CovidStore.store.setState({
                ...
                // filteredData: CovidStore.service.filterAllData(),
                filterParam: {
                    ...CovidStore.store.getState().filterParam,
                    searchParam: country
                },
